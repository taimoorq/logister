...
module InstanceConfiguration
  class Registry
    ...
    SECTIONS = [
      ...
      Section.new(key: "email", label: "Email", description: "SMTP delivery for confirmations, invitations, and alerts.", required: false),
      ...
      Section.new(key: "authentication", label: "Authentication", description: "Bot protection for public account forms.", required: false),
