...
gh release view v1.1.1 --json tagName,isLatest,isDraft,isPrerelease,publishedAt,url
...
docker pull ghcr.io/taimoorq/logister:v1.1.1
docker pull docker.io/taimoorq/logister:v1.1.1
# Optional, when the Quay.io mirror is configured:
docker pull quay.io/taimoorq/logister:v1.1.1
```
