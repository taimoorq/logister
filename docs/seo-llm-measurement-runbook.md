...
gh release view v2.6.0 --json tagName,isDraft,isPrerelease,publishedAt,url
...
docker pull ghcr.io/taimoorq/logister:v2.6.0
docker pull docker.io/taimoorq/logister:v2.6.0
# Optional, when the Quay.io mirror is configured:
docker pull quay.io/taimoorq/logister:v2.6.0
```
